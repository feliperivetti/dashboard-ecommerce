...
def display_sales_by_category_pie_chart():
    """
    Exibe um seletor de categoria e um gráfico de pizza com o faturamento
    correspondente à dimensão escolhida.
    """
    st.header("Análise de Faturamento por Categoria")
...
def display_delivery_time_histogram():
    st.header("Distribuição do Tempo de Entrega", help="Para uma melhor visualização, os valores 1% mais altos foram removidos.")
